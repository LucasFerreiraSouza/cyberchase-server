...
exports.findAll = (req, res) => {
  const disciplinaSigla = req.query.disciplina;  // Assume que você está filtrando pela sigla da disciplina

  // Se houver filtro por disciplina, buscar pelo campo disciplina.sigla
  const condition = disciplinaSigla ? { "disciplina.sigla": { $regex: new RegExp(disciplinaSigla), $options: "i" } } : {};
