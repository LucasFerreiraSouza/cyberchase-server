...
* Note: "Block" will filter all light at #000015 or allow specified colors through otherwise
* @type text
* @default #ffffff
...
* - such as 0:1, 1:9, 2:10, etc. And hex can either be a single hex color such as #000015,
* - #ffffff, a#ffffff, etc. or a range such as #000015:#ffffff, a#333333bb:a#999999bb.
...
* - id      id of region
* - color   color of block (usually #000015)
...
(function ($$) {
  ...
  */
  ...
  Lightmask.prototype._updateMask = function () {
    ...
    this._maskBitmaps.multiply.fillRect(0, 0, maxX, maxY, '#000015');
    this._maskBitmaps.additive.fillRect(0, 0, maxX, maxY, '#000015');
  ...
  */
  ...
  Mask_Bitmaps.prototype.radialgradientFlashlight = function (x, y, c, dirAngle, flashlength, flashwidth) {
    ...
    if (triangular_flashlight) { // Triangular flashlight
      ...
      ctxMul.shadowColor = "#000015"; // Clear shadow style outside of check as ctxMul state changes always occur
      ctxMul.shadowBlur = 0;
      if (!c.v) {
        ctxMul.fillStyle = grad;
        ctxMul.fillRect(x - r2, y - r2, r2 * 2, r2 * 2);
        ...
        ctxAdd.shadowColor = "#000015"; // Clear shadow style inside of check as ctxAdd state changes are conditional
        ctxAdd.shadowBlur = 0;
        ctxAdd.fillStyle = grad;
...
Game_Variables.prototype.GetDaynightColorArray = function () {
  ...
  if (!result) {
    result = ['#000015', '#000015', '#000015', '#000015',
      '#000015', '#000015', '#666666', '#AAAAAA',
      '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF',
      '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF',
      '#FFFFFF', '#FFFFFF', '#AAAAAA', '#666666',
      '#000015', '#000015', '#000015', '#000015'].map(x => x = { "color": new VRGBA(x), "isNight": false });
